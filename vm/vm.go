...
func (vm *VM) callFunction(fn *object.CompiledFunction, numArgs int) error {
	...
	frame := NewFrame(fn, vm.sp-numArgs) // To avoid the situation where the base pointer skips the arguments on the stack, we set the base pointer to the current stack pointer minus the number of arguments.
	vm.pushFrame(frame)
